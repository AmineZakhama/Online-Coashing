...
const EditProfileUForm = ({ user }) => {
    ...
    const onSaveUserClicked = async (e) => {
        if (password) {
            await updateUser({id: user.id, name, lastname, email, password})
        } else {
    ...
    let canSave
    if (password) {
        canSave = [validName, validLastname, validEmail, validPassword].every(Boolean) && !isLoading
    } else {
        canSave = [validName, validLastname, validEmail].every(Boolean) && !isLoading
    }
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3">
                                ...
                                <div className={Styles.textCenter}>
                                    ...
                                    <img src="/images/weirdface.jpg" className={Styles.imgAvatar} width="300px" alt="avatar"/>
                            ...
                            <div className={`col-md-9 ${Styles.personalInfo}`}>
                                ...
                                <div className={`${Styles.alert} ${Styles.alertBox}  alert-info alert-dismissable`}>
                                    <p className={errClass}>{errContent}</p>
                                </div>
                        
                                <h3>Personal info:</h3>
                            
                                <form className={Styles.formHorizontal} onSubmit={e => e.preventDefault()}>
                            ...
                            <div className={Styles.formGroup}>
                                    ...
                                    <div className="col-lg-8">
                                    <input 
                                        className={`${Styles.formControl} ${validPwdClass}`} 
                                        type="password" 
